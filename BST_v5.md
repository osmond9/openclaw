...
<!-- ============================================================
     PAGE 4 — SAFETY REVIEW (Multi-view)
     ============================================================ -->
<div class="page-section" id="page-safety">
  <div class="main-content">
    ...
    <div class="content-area">
      <div class="page-header">
        <div class="page-header-top">
          <div>
            ...
            <p class="page-subtitle">Manage safety reviews, risk assessments, and compliance checklists.</p>
          </div>
          <button class="btn btn-primary">
            <svg viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            New Review
      ...
      <!-- Safety View Tabs -->
      <div class="tabs">
        <div class="tab-item active" onclick="switchSafetyView('list',this)">List View</div>
        <div class="tab-item" onclick="switchSafetyView('kanban',this)">Kanban View</div>
        <div class="tab-item" onclick="switchSafetyView('gantt',this)">Gantt Chart</div>
        <div class="tab-item" onclick="switchSafetyView('detail',this)">Review Detail</div>
      </div>

      <!-- SAFETY LIST VIEW -->
      <div id="safety-view-list">
        <div class="data-table-container" style="margin-bottom:var(--space-5)">
          <table class="data-table">
            <thead>
              <tr>
                <th>Review ID</th>
            ...
            <tbody>
              <tr>
                ...
                <td style="font-size:var(--text-xs)">BMS Safety Certification</td>
                <td style="font-size:var(--text-xs)">Risk Assessment</td>
                <td><span class="tag tag-red">Critical</span></td>
                <td>Zhang Gong</td>
                <td style="color:var(--color-danger);font-size:var(--text-xs)">Jan 12 ⚠ Overdue</td>
                <td><span class="tag tag-orange">In Progress</span></td>
              </tr>
              <tr>
                <td class="cell-id">SR-002</td>
                <td class="cell-primary">High Voltage Interlock System Review</td>
                <td style="font-size:var(--text-xs)">BMS-2024 Algorithm</td>
                <td style="font-size:var(--text-xs)">Testing Validation</td>
                <td><span class="tag tag-orange">High</span></td>
                <td>Chen Ke</td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Jan 25</td>
                <td><span class="tag tag-blue">Scheduled</span></td>
              </tr>
              <tr>
                <td class="cell-id">SR-003</td>
                <td class="cell-primary">Battery Pack Structural Integrity Review</td>
                <td style="font-size:var(--text-xs)">Pack Validation Test</td>
                <td style="font-size:var(--text-xs)">Design Review</td>
                <td><span class="tag tag-default">Medium</span></td>
                <td>Li Gong</td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Feb 10</td>
                <td><span class="tag tag-default">Pending</span></td>
              </tr>
              <tr>
                <td class="cell-id">SR-004</td>
                <td class="cell-primary">Electrolyte Leakage Prevention Analysis</td>
                <td style="font-size:var(--text-xs)">Next-Gen Cell Integration</td>
                <td style="font-size:var(--text-xs)">Hazard Analysis</td>
                <td><span class="tag tag-orange">High</span></td>
                <td>Wang Lei</td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Feb 20</td>
                <td><span class="tag tag-default">Pending</span></td>
              </tr>
            </tbody>
          </table>
      ...
      <!-- SAFETY KANBAN VIEW -->
      <div id="safety-view-kanban" style="display:none">
        <div class="kanban-board">
          <div class="kanban-column">
            <div class="kanban-col-header">
            ...
            <div class="kanban-col-body">
              <div class="kanban-card">
                <div style="display:flex;justify-content:space-between;margin-bottom:var(--space-2)">
                  <span class="tag tag-default">Medium</span>
                  <span style="font-size:var(--text-xs);font-family:var(--font-mono);color:var(--color-text-quaternary)">SR-003</span>
                </div>
                <div class="kanban-card-title">Battery Pack Structural Integrity Review</div>
                <div class="kanban-card-meta">
                  <div class="kanban-card-avatar" style="background:linear-gradient(135deg,#2563EB,#3B82F6)">LG</div>
                  <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Feb 10</span>
                </div>
              ...
              <div class="kanban-card">
                <div style="display:flex;justify-content:space-between;margin-bottom:var(--space-2)">
                  <span class="tag tag-orange">High</span>
                  <span style="font-size:var(--text-xs);font-family:var(--font-mono);color:var(--color-text-quaternary)">SR-004</span>
                </div>
                <div class="kanban-card-title">Electrolyte Leakage Prevention Analysis</div>
                <div class="kanban-card-meta">
                  <div class="kanban-card-avatar" style="background:linear-gradient(135deg,#059669,#22C55E)">WL</div>
                  <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Feb 20</span>
                </div>
              </div>
            </div>
          </div>
          <div class="kanban-column">
            <div class="kanban-col-header">
              <span class="kanban-col-title">Scheduled</span>
              <span class="kanban-col-count">1</span>
            </div>
            <div class="kanban-col-body">
              <div class="kanban-card">
                <div style="display:flex;justify-content:space-between;margin-bottom:var(--space-2)">
                  <span class="tag tag-orange">High</span>
                  <span style="font-size:var(--text-xs);font-family:var(--font-mono);color:var(--color-text-quaternary)">SR-002</span>
                </div>
                <div class="kanban-card-title">High Voltage Interlock System Review</div>
                <div class="progress-bar" style="margin-bottom:var(--space-2)"><div class="progress-fill blue" style="width:10%"></div></div>
                <div class="kanban-card-meta">
                  <div class="kanban-card-avatar" style="background:linear-gradient(135deg,#D97706,#F59E0B)">CK</div>
                  <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Jan 25</span>
                </div>
              </div>
            </div>
          </div>
          <div class="kanban-column">
            ...
            <div class="kanban-col-body">
              <div class="kanban-card" style="border-left:2px solid var(--color-danger)">
                <div style="display:flex;justify-content:space-between;margin-bottom:var(--space-2)">
                  <span class="tag tag-red">Critical</span>
                  <span style="font-size:var(--text-xs);font-family:var(--font-mono);color:var(--color-text-quaternary)">SR-001</span>
                </div>
                <div class="kanban-card-title">Thermal Runaway Risk Assessment</div>
                <div class="progress-bar" style="margin-bottom:var(--space-2)"><div class="progress-fill red" style="width:45%"></div></div>
                <div class="kanban-card-meta">
                  <div class="kanban-card-avatar">ZG</div>
                  <span style="font-size:var(--text-xs);color:var(--color-danger)">Overdue 3d</span>
                </div>
              </div>
            </div>
          </div>
          <div class="kanban-column">
            ...
            <div class="kanban-col-body">
              <div style="text-align:center;padding:var(--space-6);color:var(--color-text-quaternary);font-size:var(--text-xs)">No completed reviews</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- SAFETY GANTT VIEW -->
      <div id="safety-view-gantt" style="display:none">
        <div class="gantt-placeholder">
          <div class="gantt-header-row">
            <div class="gantt-header-cell" style="text-align:left;padding-left:var(--space-4)">Safety Review</div>
            <div class="gantt-header-cell">W1 Jan</div>
            <div class="gantt-header-cell" style="background:rgba(239,68,68,0.08);color:var(--color-danger)">W2 Jan ▶</div>
            <div class="gantt-header-cell">W3 Jan</div>
            <div class="gantt-header-cell">W4 Jan</div>
            <div class="gantt-header-cell">W1 Feb</div>
            <div class="gantt-header-cell">W2 Feb</div>
            <div class="gantt-header-cell">W3 Feb</div>
            <div class="gantt-header-cell">W4 Feb</div>
            <div class="gantt-header-cell">W1 Mar</div>
            <div class="gantt-header-cell">W2 Mar</div>
            <div class="gantt-header-cell">W3 Mar</div>
            <div class="gantt-header-cell">W4 Mar</div>
          </div>
          <div class="gantt-row">
            <div class="gantt-task-name" style="font-size:var(--text-xs)">
              <span style="width:6px;height:6px;border-radius:50%;background:var(--color-danger);display:inline-block;margin-right:6px"></span>SR-001 Thermal Runaway
            </div>
            <div class="gantt-bar-container">
              <div class="gantt-bar" style="left:0%;width:25%;background:linear-gradient(90deg,#DC2626,#EF4444)"></div>
            </div>
          </div>
          <div class="gantt-row">
            <div class="gantt-task-name" style="font-size:var(--text-xs)">
              <span style="width:6px;height:6px;border-radius:50%;background:var(--color-warning);display:inline-block;margin-right:6px"></span>SR-002 HV Interlock
            </div>
            <div class="gantt-bar-container">
              <div class="gantt-bar blue" style="left:8%;width:33%"></div>
            </div>
          </div>
          <div class="gantt-row">
            <div class="gantt-task-name" style="font-size:var(--text-xs)">
              <span style="width:6px;height:6px;border-radius:50%;background:var(--color-info);display:inline-block;margin-right:6px"></span>SR-003 Pack Integrity
            </div>
            <div class="gantt-bar-container">
              <div class="gantt-bar green" style="left:25%;width:42%"></div>
            </div>
          </div>
          <div class="gantt-row">
            <div class="gantt-task-name" style="font-size:var(--text-xs)">
              <span style="width:6px;height:6px;border-radius:50%;background:var(--color-warning);display:inline-block;margin-right:6px"></span>SR-004 Electrolyte
            </div>
            <div class="gantt-bar-container">
              <div class="gantt-bar orange" style="left:33%;width:50%"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- SAFETY DETAIL VIEW -->
      <div id="safety-view-detail" style="display:none">
        <!-- SR-001 Detail -->
        <div style="margin-bottom:var(--space-5)">
          <div style="display:flex;align-items:center;gap:var(--space-3);margin-bottom:var(--space-5)">
            <span class="tag tag-red">SR-001</span>
            <h2 style="font-size:var(--text-xl);font-weight:600">Thermal Runaway Risk Assessment</h2>
            <span class="tag tag-orange" style="margin-left:auto">Overdue by 3 days</span>
          </div>
          <!-- Flow Steps -->
          <div class="card" style="margin-bottom:var(--space-5)">
            <div class="card-body">
              <div class="flow-steps">
                <div class="flow-step">
                  <div class="flow-step-number completed">✓</div>
                  <div class="flow-step-label">Initiation</div>
                </div>
                <div class="flow-connector completed"></div>
                <div class="flow-step">
                  <div class="flow-step-number completed">✓</div>
                  <div class="flow-step-label">Scope Definition</div>
                </div>
                <div class="flow-connector completed"></div>
                <div class="flow-step">
                  <div class="flow-step-number active">3</div>
                  <div class="flow-step-label active">Risk Assessment</div>
                </div>
                <div class="flow-connector"></div>
                <div class="flow-step">
                  <div class="flow-step-number">4</div>
                  <div class="flow-step-label">Mitigation Plan</div>
                </div>
                <div class="flow-connector"></div>
                <div class="flow-step">
                  <div class="flow-step-number">5</div>
                  <div class="flow-step-label">Validation</div>
                </div>
                <div class="flow-connector"></div>
                <div class="flow-step">
                  <div class="flow-step-number">6</div>
                  <div class="flow-step-label">Sign-off</div>
                </div>
              </div>
            </div>
          </div>
          <div class="two-col">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div style="display:grid;grid-template-columns:auto repeat(5,1fr);gap:3px;font-size:10px">
                  <div></div>
                  <div style="text-align:center;color:var(--color-text-quaternary);padding:3px">Rare</div>
                  <div style="text-align:center;color:var(--color-text-quaternary);padding:3px">Unlikely</div>
                  <div style="text-align:center;color:var(--color-text-quaternary);padding:3px">Possible</div>
                  <div style="text-align:center;color:var(--color-text-quaternary);padding:3px">Likely</div>
                  <div style="text-align:center;color:var(--color-text-quaternary);padding:3px">Almost Certain</div>
                  <div style="color:var(--color-text-quaternary);writing-mode:vertical-rl;text-orientation:mixed;font-size:9px;padding:3px">Critical</div>
                  <div class="risk-matrix-cell risk-medium" style="height:32px">M</div>
                  <div class="risk-matrix-cell risk-high" style="height:32px">H</div>
                  <div class="risk-matrix-cell risk-critical" style="height:32px;font-weight:800;font-size:11px">★</div>
                  <div class="risk-matrix-cell risk-critical" style="height:32px">C</div>
                  <div class="risk-matrix-cell risk-critical" style="height:32px">C</div>
                  <div style="color:var(--color-text-quaternary);font-size:9px;padding:3px">Major</div>
                  <div class="risk-matrix-cell risk-low" style="height:32px">L</div>
                  <div class="risk-matrix-cell risk-medium" style="height:32px">M</div>
                  <div class="risk-matrix-cell risk-high" style="height:32px">H</div>
                  <div class="risk-matrix-cell risk-critical" style="height:32px">C</div>
                  <div class="risk-matrix-cell risk-critical" style="height:32px">C</div>
                  <div style="color:var(--color-text-quaternary);font-size:9px;padding:3px">Moderate</div>
                  <div class="risk-matrix-cell risk-low" style="height:32px">L</div>
                  <div class="risk-matrix-cell risk-low" style="height:32px">L</div>
                  <div class="risk-matrix-cell risk-medium" style="height:32px">M</div>
                  <div class="risk-matrix-cell risk-high" style="height:32px">H</div>
                ...
                <div style="font-size:var(--text-xs);color:var(--color-text-quaternary);margin-top:var(--space-3)">★ = Current SR-001 risk position (Critical/Possible)</div>
              </div>
            </div>
            <!-- NUDD Checklist -->
            <div class="card">
              <div class="card-header"><span class="card-title">NUDD Checklist</span><span class="tag tag-blue">8/12 Done</span></div>
              <div class="card-body">
                <div style="display:flex;flex-direction:column;gap:var(--space-2)">
                  <div class="checkbox-item"><div class="checkbox-box checked"><svg viewBox="0 0 12 12"><polyline points="2 6 5 9 10 3"/></svg></div>Hazard identification complete</div>
                  <div class="checkbox-item"><div class="checkbox-box checked"><svg viewBox="0 0 12 12"><polyline points="2 6 5 9 10 3"/></svg></div>Risk severity defined per ISO 26262</div>
                  <div class="checkbox-item"><div class="checkbox-box checked"><svg viewBox="0 0 12 12"><polyline points="2 6 5 9 10 3"/></svg></div>Exposure levels assessed</div>
                  <div class="checkbox-item"><div class="checkbox-box checked"><svg viewBox="0 0 12 12"><polyline points="2 6 5 9 10 3"/></svg></div>Controllability ratings assigned</div>
                  <div class="checkbox-item"><div class="checkbox-box"></div>Thermal propagation model validated</div>
                  <div class="checkbox-item"><div class="checkbox-box"></div>Vendor test data received</div>
                  <div class="checkbox-item"><div class="checkbox-box"></div>Safety margin criteria updated</div>
                  <div class="checkbox-item"><div class="checkbox-box"></div>Mitigation actions documented</div>
                </div>
              </div>
            </div>
          </div>
...
<div class="page-section" id="page-reports">
  <div class="main-content">
    <header class="topbar">
      <div class="topbar-breadcrumb">Workspace <span class="breadcrumb-sep">/</span> <span>Report Center</span></div>
    </header>
    <div class="content-area">
      <div class="page-header">
        <div class="page-header-top">
          <div>
            ...
            <p class="page-subtitle">Generate and manage all workspace reports and analytics.</p>
          </div>
          <button class="btn btn-primary">
            <svg viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Generate Report
      ...
      <div class="three-col" style="margin-bottom:var(--space-6)">
        <div class="doc-card">
          <div class="doc-card-type"><span class="tag tag-blue">Monthly</span></div>
          <div class="doc-card-title">January 2024 Performance Report</div>
          <div class="doc-card-desc">Comprehensive monthly overview including KPIs, task completion, and project milestones.</div>
          <div class="doc-card-footer">
            <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Due Jan 31</span>
            <button class="btn btn-sm btn-primary">Generate</button>
          </div>
        </div>
        <div class="doc-card">
          <div class="doc-card-type"><span class="tag tag-red">Safety</span></div>
          <div class="doc-card-title">Safety Review Status Report</div>
          <div class="doc-card-desc">Current status of all safety reviews, overdue items, and risk assessments.</div>
          <div class="doc-card-footer">
            <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Auto-generated</span>
            <button class="btn btn-sm btn-secondary">View</button>
          </div>
        </div>
        <div class="doc-card">
          <div class="doc-card-type"><span class="tag tag-purple">Patent</span></div>
          <div class="doc-card-title">IP Portfolio Summary Report</div>
          <div class="doc-card-desc">Patent pipeline status, annual targets, and inventor contribution metrics.</div>
          <div class="doc-card-footer">
            <span style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Quarterly</span>
      ...
      <div class="card">
        ...
        <div class="card-body" style="padding:0">
          <table class="data-table">
            <thead>
              <tr><th>Report</th><th>Type</th><th>Generated</th><th>Status</th><th>Action</th></tr>
            </thead>
            <tbody>
              <tr>
                <td class="cell-primary">December 2023 Performance</td>
                <td><span class="tag tag-blue">Monthly</span></td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Jan 3, 2024</td>
                <td><span class="tag tag-green">Ready</span></td>
                <td><button class="btn btn-sm btn-ghost">Download</button></td>
              </tr>
              <tr>
                <td class="cell-primary">Q4 2023 Safety Review Summary</td>
                <td><span class="tag tag-red">Safety</span></td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Jan 5, 2024</td>
                <td><span class="tag tag-green">Ready</span></td>
                <td><button class="btn btn-sm btn-ghost">Download</button></td>
              </tr>
              <tr>
                <td class="cell-primary">2023 Annual IP Portfolio</td>
                <td><span class="tag tag-purple">Patent</span></td>
                <td style="font-size:var(--text-xs);color:var(--color-text-quaternary)">Jan 8, 2024</td>
                <td><span class="tag tag-green">Ready</span></td>
                <td><button class="btn btn-sm btn-ghost">Download</button></td>
              </tr>
            </tbody>
