  ...
  <div class="main-content">
    ...
    <div id="aiDashboard" style="display:none;flex:1;overflow:hidden">
      <div class="ai-dashboard">
        ...
        <!-- BOTTOM: AI Chat Panel (horizontal full-width) -->
        <div class="ai-dashboard-right">
          <div style="display:flex;align-items:center;justify-content:space-between;padding:var(--space-3) var(--space-5);border-bottom:1px solid var(--color-border)">
            <div style="display:flex;align-items:center;gap:var(--space-2)">
              ...
              <span style="font-size:var(--text-xs);color:var(--color-text-quaternary);margin-left:var(--space-2)">Workspace context loaded — 24 tasks · 6 projects · 3 safety reviews · 3 patents</span>
            </div>
            <button class="btn btn-ghost btn-sm">New Chat</button>
          </div>

          <!-- Messages row (horizontal scroll) -->
          <div style="flex:1;overflow-y:auto;padding:var(--space-3) var(--space-5);display:flex;flex-direction:column;gap:var(--space-3)" id="aiChatMessages">
            <div class="ai-message assistant" style="margin-bottom:0">
              <div class="ai-avatar assistant">AI</div>
              <div class="ai-bubble" style="max-width:none">
                <strong>Today's Priority Summary</strong> &nbsp;—&nbsp;
                🔴 <strong>SR-001</strong> overdue 3 days &nbsp;·&nbsp;
                🟡 <strong>TSK-019</strong> due Jan 18 (65%) &nbsp;·&nbsp;
                🟢 Performance score <strong>92</strong> ↑+5 MoM
                &nbsp; What would you like to work on first?
              </div>
            </div>
          </div>

          <!-- Quick commands + input in one row -->
          <div style="padding:var(--space-2) var(--space-5) var(--space-3);display:flex;flex-direction:column;gap:var(--space-2);border-top:1px solid var(--color-border)">
            ...
            <div style="display:flex;align-items:flex-end;gap:var(--space-3)">
              <textarea class="ai-input-field" id="aiDashInput" placeholder="Ask BST AI anything... (Enter to send)" rows="1" onkeydown="handleAIDashInput(event)" style="flex:1"></textarea>
